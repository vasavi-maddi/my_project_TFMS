...
<title>REVATURE-Batch details</title>
		...
		<div class="container mt-5 px-2">
			<div class="table-responsive">
				<input type="text" id="myInput" onkeyup="searchFunction()"
					placeholder="Search topic names.." title="Type in a name">
				<%
				try {
				...
				%><table class="table table-responsive table-borderless"
					id="myTable" style="text-align: center">
					<thead>
						<tr class="bg-light">
							<th scope='col' width='20%'>Topic Name</th>
							<th scope='col' width='20%'>Start date</th>
							<th scope='col' width='20%'>End date</th>
							<th scope='col' width='20%'>Duration</th>
							<th scope='col' width='20%'>Trainer id</th>
							<th scope='col' width='20%'>Associate id</th>
						</tr>
					</thead>
					<tbody>
						<%
						...
						<tr>
							...
							<td><%=rs.getString("batch_duration")%></td>
							<td><%=rs.getString("trainer_id")%></td>
							<td><%=rs.getString("associate_id")%></td>
						</tr>
						<%
						}
						%>
		...
		<footer id="footer">
						...
						<div class="col-lg-2 col-md-6 footer-links">
							...
							<ul>
								<li><i class="bx bx-chevron-right"></i> <a
									href="index2.jsp">Home</a></li>
								<li><i class="bx bx-chevron-right"></i> <a href="">Register
										New Trainer</a></li>
							</ul>
						</div>
			...
			<div class="container d-md-flex py-4">
				<div class="me-md-auto text-center text-md-start">
					<div class="copyright">
						&copy; Copyright <strong><span>CodeTech</span></strong>. All
						Rights Reserved
					</div>
					<div class="credits">
